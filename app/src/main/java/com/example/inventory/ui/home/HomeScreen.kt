...
private fun InventoryItem(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text =  if (!Settings.hideSensitiveData || item.providerPhoneNumber == "") item.providerPhoneNumber else "*******",
                style = MaterialTheme.typography.titleMedium
            )
            Text(
                text =  if (!Settings.hideSensitiveData || item.providerEmail == "") item.providerEmail else "*******",
                style = MaterialTheme.typography.titleMedium
            )
        }
    }
